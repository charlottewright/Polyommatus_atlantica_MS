...
read_and_combine_random_files <- function(file_dir, file_prefix, repeat_types) {
  ...
  for (i in repeat_types) {
    file_name <- paste0(file_prefix, i, '.tsv')
...
# Read in Polyommatus atlantica 
file_dir = 'final_breakpoints/'
file_prefix <- 'repeat_density_of_random_regions_10000_Polyommatus_icarus.filteredRepeats.'
ilPolAtal_v3_random_df <- read_and_combine_random_files(file_dir, file_prefix, repeat_types)
file_prefix <- 'repeat_density_of_ilPolAtla_vs_ilPolIcar_breakpoints.in_ilPolIcar_locations.filteredRepeats.'
...
ggsave(hist_plot, filename='repeat_density_random_vs_observed.ilPolAtla.140325.pdf',height=7, width=10)
ggsave(hist_plot, filename='repeat_density_random_vs_observed.ilPolAtla.140325.png',height=7, width=10)
